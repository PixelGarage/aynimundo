<?php
	function aynimundo_preprocess_page(&$variables) {
     drupal_add_css('http://fonts.googleapis.com/css?family=Cabin+Condensed:400,500,700|Open+Sans+Condensed:700,300', array('type' => 'external', 'group' => CSS_THEME, 'weight' => -10));
	}
